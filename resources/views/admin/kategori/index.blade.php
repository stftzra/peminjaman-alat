...
<div class="p-6">
    ...
    {{-- Header --}}
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-2">Data Kategori</h1>
        <p class="text-gray-600">Kelola semua kategori alat</p>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-semibold text-gray-900">{{ $kategoris->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-semibold text-gray-900">{{ $kategoris->sum(function($cat) { return $cat->alats ? $cat->alats->count() : 0; }) }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="{{ route('admin.kategori.create') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700">
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div class="w-10 h-10 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-lg flex items-center justify-center text-white font-semibold">
                    ...
                    <tr>
                        <td colspan="2" class="px-6 py-12 text-center">
                            <div class="text-gray-500">
                                ...
                                <p class="text-xs text-gray-400 mt-1">Tambahkan kategori pertama untuk memulai</p>
                            </div>
                        </td>   
                    </tr>
                    @endforelse
